...
public class concussion_gameLayer extends CCColorLayer {
	...
	public static CCScene scene()
	{
	    ...
	    CCColorLayer layer = new concussion_gameLayer(ccColor4B.ccc4(255, 255, 255, 255));
	    scene.addChild(layer);	 
	    return scene;
	}
	
	protected concussion_gameLayer(ccColor4B color){
		super(color);
